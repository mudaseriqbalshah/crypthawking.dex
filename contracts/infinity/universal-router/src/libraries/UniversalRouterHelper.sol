...
import {IHawkingV2Pair} from "../modules/pancakeswap/v2/interfaces/IHawkingV2Pair.sol";
import {IHawkingV3Pool} from "../modules/pancakeswap/v3/interfaces/IHawkingV3Pool.sol";
...
library UniversalRouterHelper {
        ...
        returns (address pair, uint256 reserveA, uint256 reserveB)
    {
        ...
        (uint256 reserve0, uint256 reserve1,) = IHawkingV2Pair(pair).getReserves();
