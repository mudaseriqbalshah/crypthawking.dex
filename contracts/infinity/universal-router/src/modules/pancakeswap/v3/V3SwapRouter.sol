...
import {IHawkingV3Pool} from "./interfaces/IHawkingV3Pool.sol";
import {IHawkingV3SwapCallback} from "./interfaces/IHawkingV3SwapCallback.sol";
...
abstract contract V3SwapRouter is RouterImmutables, Permit2Payments, IHawkingV3SwapCallback {
        ...
        returns (int256 amount0Delta, int256 amount1Delta, bool zeroForOne)
    {
        ...
        (amount0Delta, amount1Delta) = IHawkingV3Pool(
                UniversalRouterHelper.computePoolAddress(
                    PANCAKESWAP_V3_DEPLOYER, PANCAKESWAP_V3_POOL_INIT_CODE_HASH, tokenIn, tokenOut, fee
                )
            )
