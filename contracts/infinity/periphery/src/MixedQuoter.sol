...
import {IHawkingV3Pool} from "./interfaces/external/IHawkingV3Pool.sol";
import {IHawkingV3SwapCallback} from "./interfaces/external/IHawkingV3SwapCallback.sol";
...
contract MixedQuoter is IMixedQuoter, IHawkingV3SwapCallback, Multicall {
    using SafeCast for *;
    using V3PoolTicksCounter for IHawkingV3Pool;
    ...
    function hawkingV3SwapCallback(int256 amount0Delta, int256 amount1Delta, bytes memory data) external view override {
        ...
        IHawkingV3Pool pool = V3SmartRouterHelper.getPool(factoryV3, tokenIn, tokenOut, fee);
    ...
    function handleV3Revert(bytes memory reason, IHawkingV3Pool pool, uint256 gasEstimate)
        private
        view
        ...
        returns (uint256 amountOut, uint160 sqrtPriceX96After, uint32 initializedTicksCrossed, uint256 gasEstimate)
    {
        ...
        IHawkingV3Pool pool = V3SmartRouterHelper.getPool(factoryV3, params.tokenIn, params.tokenOut, params.fee);
