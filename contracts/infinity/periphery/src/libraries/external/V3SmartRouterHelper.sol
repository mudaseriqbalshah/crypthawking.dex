...
import {IHawkingPair} from "../../interfaces/external/IHawkingPair.sol";
import {IHawkingV3Pool} from "../../interfaces/external/IHawkingV3Pool.sol";
import {IHawkingFactory} from "../../interfaces/external/IHawkingFactory.sol";
import {IHawkingV3Factory} from "../../interfaces/external/IHawkingV3Factory.sol";
...
library V3SmartRouterHelper {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal view returns (address pair) {
        ...
        return IHawkingFactory(factory).getPair(token0, token1);
    }
    ...
    function getPool(address factory, address tokenA, address tokenB, uint24 fee)
        internal
        view
        returns (IHawkingV3Pool)
    {
        if (tokenA > tokenB) (tokenA, tokenB) = (tokenB, tokenA);
        return IHawkingV3Pool(IHawkingV3Factory(factory).getPool(tokenA, tokenB, fee));
    }
