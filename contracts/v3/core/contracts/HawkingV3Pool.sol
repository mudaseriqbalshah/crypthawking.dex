...
import './interfaces/IHawkingV3Pool.sol';
...
import './interfaces/IHawkingV3PoolDeployer.sol';
import './interfaces/IHawkingV3Factory.sol';
import './interfaces/IERC20Minimal.sol';
import './interfaces/callback/IHawkingV3MintCallback.sol';
import './interfaces/callback/IHawkingV3SwapCallback.sol';
import './interfaces/callback/IHawkingV3FlashCallback.sol';

import './interfaces/lm/IHawkingV3LmPool.sol';

contract HawkingV3Pool is IHawkingV3Pool {
    ...
    /// @inheritdoc IHawkingV3PoolImmutables
    ...
    /// @inheritdoc IHawkingV3PoolState
    ...
    // liquidity mining
    IHawkingV3LmPool public lmPool;
    ...
    modifier onlyFactoryOrFactoryOwner() {
        require(msg.sender == factory || msg.sender == IHawkingV3Factory(factory).owner());
        _;
    }

    constructor() {
        int24 _tickSpacing;
        (factory, token0, token1, fee, _tickSpacing) = IHawkingV3PoolDeployer(msg.sender).parameters();
    ...
    /// @inheritdoc IHawkingV3PoolDerivedState
    ...
    /// @inheritdoc IHawkingV3PoolActions
    ...
    function mint(
        ...
        IHawkingV3MintCallback(msg.sender).hawkingV3MintCallback(amount0, amount1, data);
    ...
    function swap(
        ...
        if (zeroForOne) {
            ...
            IHawkingV3SwapCallback(msg.sender).hawkingV3SwapCallback(amount0, amount1, data);
    ...
    function flash(
        ...
        IHawkingV3FlashCallback(msg.sender).hawkingV3FlashCallback(fee0, fee1, data);
    ...
    /// @inheritdoc IHawkingV3PoolOwnerActions
    ...
    function setLmPool(address _lmPool) external override onlyFactoryOrFactoryOwner {
      lmPool = IHawkingV3LmPool(_lmPool);
