...
import '@cryptohawking/v3-core/contracts/libraries/LowGasSafeMath.sol';
...
import '@cryptohawking/v3-core/contracts/libraries/FixedPoint128.sol';
import '@cryptohawking/v3-core/contracts/interfaces/IHawkingV3Pool.sol';

import './libraries/LmTick.sol';

import './interfaces/IHawkingV3LmPool.sol';
import './interfaces/IMasterChefV3.sol';
import './interfaces/IHawkingV3LmPoolDeveloper.sol';

contract HawkingV3LmPool is IHawkingV3LmPool {
  ...
  IHawkingV3Pool public immutable pool;
  ...
  constructor() {
    (address poolAddress, address masterChefAddress) = IHawkingV3LmPoolDeveloper(msg.sender).parameters();
    pool = IHawkingV3Pool(poolAddress);
